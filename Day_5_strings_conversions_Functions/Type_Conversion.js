...
Security
Insights
Foundations_26/Week_02/Day_01/Type_conversion.js /
@kelvin711
kelvin711 finished stings and type conversion lecture notes
Latest commit c7fae0f 20 hours ago
 History
 1 contributor
112 lines (95 sloc)  4.05 KB
...
let converted_string = 4.00
console.log(typeof converted_string);
converted_string = Boolean(converted_string) 
console.log(typeof converted_string);
